...
const menuGroups = [
  ...
  { title: "基础资料", items: [{ href: "/customers", label: "客户管理" }, { href: "/products", label: "产品管理" }, { href: "/parts", label: "部件管理" }, { href: "/drawings", label: "图纸管理" }] },
  ...
  { title: "系统工具", items: [{ href: "/imports/excel", label: "Excel 导入" }, { href: "/settings/data", label: "数据管理" }, { href: "/settings/backup", label: "系统备份" }] }
];
