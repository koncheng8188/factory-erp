...
export function PrintActions({ deliveryOrderId }: { deliveryOrderId: string }) {
  return (
    <div className="no-print mb-5 flex flex-wrap items-center gap-3 rounded-lg border border-[#d8dde6] bg-white px-4 py-3">
      ...
      <button
        className="inline-flex items-center gap-2 rounded-md bg-slate-900 px-4 py-2 text-sm font-semibold text-white !text-white shadow-sm hover:bg-slate-700 hover:text-white hover:!text-white"
        style={{ color: "#ffffff" }}
        type="button"
