      ...
      <body>
        <div className="min-h-screen bg-[#f6f7f9] text-[#172033]">
          <aside className="fixed inset-y-0 left-0 hidden w-64 border-r border-[#d8dde6] bg-white shadow-[4px_0_18px_rgba(16,24,40,0.04)] md:block">
            <div className="border-b border-[#d8dde6] px-6 py-6">
          ...
          <div className="md:pl-64">
            <header className="sticky top-0 z-10 border-b border-[#d8dde6] bg-white/95 px-5 py-4 backdrop-blur md:px-8">
              <div className="mx-auto flex max-w-[1680px] items-center justify-between gap-4">
                <div>
                  <div className="text-xl font-semibold text-[#172033]">金鸿 ERP</div>
                  <div className="text-sm text-[#667085]">五金定制家具订单生产管理系统</div>
                </div>
                <div className="hidden rounded-md border border-[#d8dde6] bg-[#fbfcfd] px-3 py-2 text-sm font-medium text-[#475467] sm:block">
                  下料 / 焊接 / 抛光 / 外发 / 送货
                </div>
              </div>
            </header>
